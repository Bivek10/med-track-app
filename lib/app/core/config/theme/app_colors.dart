...
class AppColors {
  static const MaterialColor primary = MaterialColor(0xFF378EF0, <int, Color>{
    50: Color(0xFFF4F9FF),
    ...
    600: Color(0xFFA5E4FF),
    700: Color(0xFF4BB5F9),
    800: Color(0xFF15B8FF),
    900: Color(0xFF65CCF9),
  });
  ...
  static const Color black= Color(0x0000000);
  ...
  //static const Color softGreen = Color(0x1A00BF8C);
